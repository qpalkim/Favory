...
export default function Page() {
  ...
  return (
    <section aria-label="감상평 수정 페이지" className="min-h-screen bg-gradient-to-br from-green-600 via-green-500 via-60% to-green-100 px-4 py-[52px] md:px-0 md:py-[70px] lg:py-[100px]">
