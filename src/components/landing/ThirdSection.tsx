...
export default function ThirdSection() {
  return (
    ...
    >
      <div aria-hidden className="relative flex h-[210px] w-[312px] items-center justify-center overflow-hidden rounded-lg bg-white bg-radial from-green-600 to-green-500 shadow-2xl transition-transform duration-300 hover:scale-105 md:h-[290px] md:w-[488px]">
        <div aria-hidden className="border-black-200 absolute aspect-square w-[100px] rounded-full border border-dashed md:w-[160px]" />
        <div aria-hidden className="border-black-200 absolute aspect-square w-[200px] rounded-full border md:w-[312px]" />
        <div aria-hidden className="border-black-200 absolute aspect-square w-[280px] rounded-full border md:w-[450px]" />
        <Image
          src={logo}
          alt="Favory 로고"
          draggable={false}
