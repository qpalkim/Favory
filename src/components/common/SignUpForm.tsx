...
import { useLogin, useSendEmailVerification, useSignUp, useVerifyEmailCode } from "@/lib/hooks/useAuth";
...
import EmailVerificationMdoal from "./modal/EmailVerificationModal";
...
export default function SignUpForm() {
  ...
  const { mutateAsync: sendEmail } = useSendEmailVerification();
  const { mutateAsync: verifyEmail } = useVerifyEmailCode();
  ...
  const onSubmit = async (data: SignUpRequest) => {
    ...
    try {
      await signUp({ ...data, verifyToken: verifyToken });
