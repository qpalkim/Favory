  ...
  return (
    ...
    >
      ...
      <div className="min-w-0 flex-1">
        ...
        <h3 className="text-black-500 lg:text-2lg mt-2 truncate text-sm leading-tight font-medium md:text-lg">
          {favoryDetail.favoryTitle}
        </h3>
        <p className="text-black-500 md:text-md mt-1 truncate text-xs leading-tight lg:text-lg">
