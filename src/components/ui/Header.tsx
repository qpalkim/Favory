      ...
      <div className="relative mx-auto flex h-10 max-w-[1448px] items-center justify-between px-6 transition-all md:h-12 lg:h-14">
        <Link href="/">
          <Image
            src={logo}
            alt="헤더 로고"
            className="w-[86px] transition-opacity hover:opacity-80 md:w-[101px] lg:w-[114px]"
          />
        </Link>
        <Link
          href="/login"
          className="text-md md:text-2lg font-semibold text-white transition-opacity hover:opacity-80 lg:text-xl"
